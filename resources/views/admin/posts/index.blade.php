                            ...
                            <tbody>
                                @foreach ($data as $row)
                                    <tr class="id{{ $row->id }}">
                                        ...
                                        @if (Request::segment(2) == 'pricing')
                                            <td>
                                                {{ optional(\App\Models\Posts\PostModel::find($row->post_parent))->post_title ?? '-' }}
                                            </td>
                                        ...
                                        <td>
                                            @if (
                                                $row->id == 17 ||
                                                    (Request::segment(2) == 'product' && Request::segment(3)) ||
                                                    (Request::segment(2) == 'frontpage' && $row->id == 29))
                                            ...
                                            @if (Request::segment(2) == 'gallery' ||
                                                    (Request::segment(2) == 'frontpage' && $row->id == 28) ||
