...
@section('breadcrumb')
<a href="{{ route('admin.multiplevideo.create', Request::segment(2) ) }}" class="btn btn-primary btn-sm">Create</a>
@endsection
@section('content')
          ...
          <tbody>
            ...
            <tr class="id{{$row->id}}">
              ...
              <td class="post_title title_hi_sh">                
                ...
                <a href="{{route('admin.multiplevideo.edit',['post_id'=>Request::segment(2),'id'=>$row->id])}}">Edit</a> | </span><span class="trash"><a href="#{{$row->id}}" class="submitdelete" data-postid="{{Request::segment(2)}}">Delete</a> </span>
                </td>
                <td>
                </td>
